...
- If on another -v: use [NVM](https://github.com/nvm-sh/nvm?tab=readme-ov-file#set-default-node-version) by installing with `curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.40.3/install.sh | bash`
